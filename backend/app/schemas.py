...
class SignupRequest(BaseModel):
    ...
    package_tier: Optional[str] = Field(
        default=None,
...
class UserPublic(BaseModel):
    ...
    package_tier: str = Field(..., description="User's subscription package")
...
class DashboardFeature(BaseModel):
    ...
    limit: Optional[int] = Field(default=None, description="Optional quota limit")
...
class PlanInfo(BaseModel):
    ...
    package_tier: str = Field(..., description="The current subscription package tier")


# PUBLIC_INTERFACE
class PlanUpdateRequest(BaseModel):
    """Payload to update the current user's plan/package."""
    package_tier: str = Field(..., description="New subscription package tier to apply")
...
class TailoredContentResponse(BaseModel):
    ...
    data_pro: Optional[List[str]] = Field(default=None, description="Additional data for pro and above")
    data_enterprise: Optional[List[str]] = Field(default=None, description="Additional data for enterprise only")
    analytics: Optional[Dict[str, Any]] = Field(default=None, description="Enterprise analytics bundle")
